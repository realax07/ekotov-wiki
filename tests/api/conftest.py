"""Фикстуры API-тестов: add-kanban-core (R1) + add-r2-categories-settings (R2).
...
# ==========================================================================
# Релиз 2 (change add-r2-categories-settings): Конфигурация набора add-r2-categories-settings: категории, миграция,
# (слито из бывшего conftest_r2.py — один conftest на каталог, порядок 2026-09-23)
# ==========================================================================
